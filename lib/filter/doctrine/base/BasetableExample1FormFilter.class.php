...
/**
 * tableExample1 filter form base class.
 *
 ...
 */
abstract class BasetableExample1FormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('table_example1_filters[%s]');
